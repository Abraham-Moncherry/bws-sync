...
<details>
  ...
  <ol>
    ...
    <li><a href="#usage">Usage</a>
      <ul>
        <li><a href="#bulk-import-from-env-output">Bulk Import from Env Output</a></li>
...
4. Sync secrets:
   ...
   - **Staging / Production** — choose to paste env output (bulk) or enter each value manually, then updates your workflow file and GitHub environment
